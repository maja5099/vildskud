...
!(function (e) {
  ...
  var t = function (e) {
    ...
    if (
      !e.CORE_VERSION ||
      !i.compareVersions(t.REQUIRE_CORE_VERSION, e.CORE_VERSION)
    )
      throw new Error(
    ...
    e.ConfigCallbacks.registerAction(
      "afterConstruct",
      "multifilter",
      function () {
      ...
      i.extend(e.FilterGroup.prototype, {
        init: function (e, t) {
          ...
          (i.dom.el = e),
            ...
            (i.mixer = t),
            ((r && "and" === r.toLowerCase()) ||
              "and" === t.config.multifilter.logicWithinGroup) &&
              (i.logic = "and"),
            i.bindEvents();
        },
        cacheDom: function () {
        ...
        bindEvents: function () {
          ...
          (e.handler = function (t) {
            ...
            e.dom.form &&
              (i.on(e.dom.form, "reset", e.handler),
              i.on(e.dom.form, "submit", e.handler));
        },
        unbindEvents: function () {
          ...
          i.off(e.dom.el, "click", e.handler),
            ...
            e.dom.form &&
              (i.off(e.dom.form, "reset", e.handler),
              i.off(e.dom.form, "submit", e.handler)),
            (e.handler = null);
        },
          ...
          r &&
            (((o = t.mixer.config.selectors.control) && !r.matches(o)) ||
              ...
              r.matches("[data-filter]")
                ? ((n = r.getAttribute("data-filter")),
                  (t.activeSelectors = t.activeToggles = [n]))
                : r.matches("[data-toggle]") &&
                  ((n = r.getAttribute("data-toggle")),
                  (l = t.activeToggles.indexOf(n)) > -1
                    ? t.activeToggles.splice(l, 1)
                    : t.activeToggles.push(n),
                  "and" === t.logic
                    ? (t.activeSelectors = [t.activeToggles])
                    : (t.activeSelectors = t.activeToggles)),
              t.updateControls(),
        ...
        handleKeyup: function (e) {
          ...
          if (!(["text", "search", "email"].indexOf(i.type) < 0)) {
            if ("change" !== t.mixer.config.multifilter.parseOn)
              return void t.mixer.getSingleValue(i);
        ...
        handleFormEvent: function (t) {
          ...
          if (
            ...
            for (
              r = i.mixer.multifilterFormEventTracker =
                new e.MultifilterFormEventTracker(),
                r.form = t.target,
                l = 0;
              (o = i.mixer.filterGroups[l]);
              l++
            )
          ...
          t.target === r.form &&
            ...
            r.totalHandled === r.totalBound &&
              ...
              ("submit" !== t.type &&
                "change" !== i.mixer.config.multifilter.parseOn) ||
                i.mixer.parseFilterGroups()));
        },
        getSingleValue: function (e) {
          ...
          if (e.type.match(/text|search|email/g)) {
            ...
            if (e.value.length < t.mixer.config.multifilter.minSearchLength)
              return void (t.activeSelectors = t.activeToggles = [""]);
            (o = e.value.replace(/\W+/g, " ").toLowerCase().trim()),
              (r = "[" + i + '*="' + o + '"]');
          } else r = e.value;
          "string" == typeof e.value &&
            (t.activeSelectors = t.activeToggles = [r]);
        },
        getMultipleValues: function (e) {
          ...
          for (l = t.dom.el.querySelectorAll(r), n = 0; (o = l[n]); n++)
            (o.checked || o.selected) && o.value && i.push(o.value);
          (t.activeToggles = i),
            "and" === t.logic
              ? (t.activeSelectors = [i])
              : (t.activeSelectors = i);
        ...
        updateControls: function (e) {
          var t = this,
            ...
            o = -1;
          for (
            e = e || t.dom.el.querySelectorAll("[data-filter], [data-toggle]"),
              o = 0;
            (i = e[o]);
            o++
          )
            i.getAttribute("data-toggle") && (r = "toggle"),
              t.updateControl(i, r);
        },
        updateControl: function (e, t) {
          var r = this,
            ...
            l = "";
          (l = i.getClassname(
            r.mixer.config.classNames,
            t,
            r.mixer.config.classNames.modifierActive
          )),
            r.activeToggles.indexOf(o) > -1
              ? i.addClass(e, l)
              : i.removeClass(e, l);
        },
        updateUi: function () {
          ...
          for (t.length && e.updateControls(t, !0), l = 0; (o = i[l]); l++)
            switch (
              ((r = e.activeToggles.indexOf(o.value) > -1),
      ...
      e.Mixer.registerAction("afterSanitizeConfig", "multifilter", function () {
        var e = this;
        (e.config.multifilter.logicBetweenGroups =
          e.config.multifilter.logicBetweenGroups.toLowerCase().trim()),
          (e.config.multifilter.logicWithinGroup =
            e.config.multifilter.logicWithinGroup.toLowerCase().trim());
      }),
      ...
      e.Mixer.extend({
        indexFilterGroups: function () {
          ...
          for (o = 0; (r = t.dom.filterGroups[o]); o++)
            if (
              ((i = new e.FilterGroup()),
              i.init(r, t),
              t.filterGroups.push(i),
              i.name)
            ) {
              if ("undefined" != typeof t.filterGroupsHash[i.name])
                throw new Error(
        ...
        parseParseFilterGroupsArgs: function (t) {
          var r = this,
            ...
            n = -1;
          for (
            o.animate = r.config.animation.enable,
            ...
            (l = t[n]),
              "boolean" == typeof l
                ? (o.animate = l)
                : "function" == typeof l && (o.callback = l);
          return i.freeze(o), o;
        },
        getFilterGroupPaths: function () {
          var e = this,
            ...
            a = [],
            s = -1;
          for (s = 0; s < e.filterGroups.length; s++)
            (o = e.filterGroups[s].activeSelectors).length &&
              (l.push(o), a.push(0));
          return (
            (t = function () {
              var e = null,
            ...
            (r = function (e) {
              e = e || 0;
              for (var i = l[e]; a[e] < i.length; )
                e < l.length - 1 ? r(e + 1) : t(), a[e]++;
              a[e] = 0;
            }),
            l.length ? (r(), n) : ""
          );
        ...
        buildSelectorFromPaths: function (e) {
          ...
          if (!e.length) return "";
          if (
            ("or" === t.config.multifilter.logicBetweenGroups && (l = ", "),
            e.length > 1)
          ) {
            for (n = 0; n < e.length; n++)
              (i = e[n]), (o = i.join(l)), r.indexOf(o) < 0 && r.push(o);
            return r.join(", ");
          }
          return e[0].join(l);
        },
        parseFilterGroups: function () {
          ...
          return (
            ...
            (l.filter = t.command),
            "function" == typeof (o = e.config.callbacks.onParseFilterGroups) &&
              (l = o(l)),
        ...
        setFilterGroupSelectors: function (e, t) {
          ...
          if (
            ...
            "undefined" == typeof (r = i.filterGroupsHash[e]))
          )
            throw new Error(
          ...
          (r.activeToggles = t.slice()),
            "and" === r.logic
              ? (r.activeSelectors = [r.activeToggles])
              : (r.activeSelectors = r.activeToggles),
            r.updateUi(r.activeToggles);
        },
        getFilterGroupSelectors: function (e) {
          var t = this,
            i = null;
          if ("undefined" == typeof (i = t.filterGroupsHash[e]))
            throw new Error(
              '[MixItUp MultiFilter] No filter group could be found with the name "' +
                e +
                '"'
  ...
  if (
    ...
    if (!e.mixitup || "function" != typeof e.mixitup)
